...
<html lang="en">
									...
									<div class="form-group">
										...
										<input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="new-password">
											<div class="input-group-append">
												<button class="btn" type="button" id="button-addon2" onclick="myFunction()"><img src="{{asset('image/ilustrasi/eye-slash-fill.svg')}}" alt="" width="20px"></button>
											</div>
											@error('password')
											<span class="invalid-feedback" role="alert">
												<strong>{{ $message }}</strong>
	...
	<script>
		...
		function showPass1() {
			var y = document.getElemenById("password-confirm");
			if(y.type === "password-confirm"){
				y.type = "text";
			}else{
				y.type = "password";
			}
